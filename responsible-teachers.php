...
// ======================================================
// สร้าง / อัปเดตข้อมูลเริ่มต้น
// ======================================================

// เปลี่ยนเลขเวอร์ชันเมื่อมีการแก้ข้อมูลเริ่มต้น
$teacherVersion = 2;

if (
    !isset($_SESSION["teacher_version"]) ||
    $_SESSION["teacher_version"] != $teacherVersion
) {
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($action === "add") {
        ...
        $_SESSION["teachers"][] = $newTeacher;


        header("Location: responsible-teachers.php");
    ...
    if ($action === "delete") {
        ...
        // จัดลำดับ Array ใหม่
        $_SESSION["teachers"] =
            array_values($_SESSION["teachers"]);
...
<div class="content">
    ...
    <div class="topbar">
        ...
        <p>
            เพิ่ม แก้ไข และลบข้อมูลอาจารย์ผู้รับผิดชอบหลักสูตร
        </p>
