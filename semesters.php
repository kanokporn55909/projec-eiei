...
$needResetSemesters = false;

if (
    !isset($_SESSION["semesters"]) ||
    $needResetSemesters
) {
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($action === "add") {
        ...
        $_SESSION["semesters"][] = $newSemester;
    ...
    if ($action === "edit") {
        ...
        foreach (
            $_SESSION["semesters"] as &$semester
        ) {
    ...
    if ($action === "delete") {
        ...
        foreach (
            $_SESSION["semesters"] as $key => $semester
        ) {

            if ($semester["id"] == $id) {

                unset(
                    $_SESSION["semesters"][$key]
                );
...
<div class="content">
    ...
    <div class="topbar">
        ...
        <p>
            เพิ่ม แก้ไข และลบข้อมูลภาคการศึกษา
        </p>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form
                                        ...
                                        onsubmit="
                                            return confirm(
                                                'ต้องการลบ <?= htmlspecialchars($semester["semester"]) ?> หรือไม่?'
                                            );
                                        "
                                    >
